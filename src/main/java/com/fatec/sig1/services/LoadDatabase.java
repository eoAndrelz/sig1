...
class LoadDatabase {
	...
	CommandLineRunner initDatabase(MantemClienteRepository repository) {
		return args -> {
			...
			Cliente cliente1 = new Cliente("Jose da Silva", "01/03/1964","1194865-7485", "M", "59672555598", "03694000", "2983");
			cliente1.setEndereco("Aguia de Haia");
			log.info("Preloading " + repository.save(cliente1));
			Cliente cliente2 = new Cliente("Carlos Alberto", "19/08/1970","1194865-7485", "M", "16467548671", "04280130", "59");
