...
public class ClienteDTO {
	...
	public ClienteDTO(String nome, String dataNascimento, String sexo, String cpf, String cep,String telefone, String complemento) {
		this.nome = nome;
	...
	public Cliente retornaUmCliente() {
		return new Cliente(nome, dataNascimento,telefone,sexo, cpf, cep, complemento);
	}
}
